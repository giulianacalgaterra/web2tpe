...
class VeterinariaModel{
    ...
    function getCliente($dni){
        $sentencia = $this->db->prepare( "SELECT clientes.nombre, clientes.apellido, clientes.dni, clientes.fecha_de_alta, clientes.fecha_de_actualizacion FROM clientes INNER JOIN mascotas ON m.dni_cliente = c.dni WHERE id=?;");
